...
describe('schema » transform » price', function () {
  it('round from min', function (done) {
    const item = {
      ...
      'path': 'masts',
      'link': 'https://easy-surfshop.com/do/item/N-NORTH-SAILS-2017-WINDSURF-MAST-SILVER-SDM/NORTH-SAILS-Windsurf-Mast-SILVER-SDM-2017?ref=windtodayco',
      'image': 'https://images.easy-surfshop.com/images/_small/N-NORTH-SAILS-2017-WINDSURF-MAST-SILVER-SDM.jpg',
